...
>- <cite>[Wikipedia](http://en.wikipedia.org/wiki/Data_structure)</cite>
...
and [more](http://en.wikipedia.org/wiki/List_of_data_structures),
including
...
**For the most part, in your day-to-day programming, stick to the data
structures provided by your language. Don't start your first day on
some job by implementing your own linked list.**
...
**This is an oversimplification but it is close enough of a model to
...
do a better job of managing memory.**
...
A [Linked List](http://en.wikipedia.org/wiki/Linked_list) (or
__Singly Linked List__) is another way of organizing a list of
elements.
...
In a way, a [Tree](http://en.wikibooks.org/wiki/Data_Structures/Trees)
is like a more generalized version of a Linked List where each Node
...
* [Depth-first search](http://en.wikipedia.org/wiki/Depth-first_search), and
...
* Heaps
    - See [wikibooks](http://en.wikibooks.org/wiki/Data_Structures/Min_and_Max_Heaps)
...
>- <cite>[Wikipedia](http://en.wikipedia.org/wiki/Big_O_notation)</cite>
...
See the [Cheat Sheet](http://bigocheatsheet.com/) for some other
common time (processing time) and space (memory) complexities and
their notations.
...
* [Array on Wikipedia](http://en.wikipedia.org/wiki/Array_data_structure)
* [Linked Lists on Wikipedia](http://en.wikipedia.org/wiki/Linked_list)
* [Trees on Wikibooks](http://en.wikibooks.org/wiki/Data_Structures/Trees)
* [Heaps on Wikibooks](http://en.wikibooks.org/wiki/Data_Structures/Min_and_Max_Heaps)
* [Big-O Cheat Sheet](http://bigocheatsheet.com/)
* [64-bit Computing](http://en.wikipedia.org/wiki/64-bit_computing)
